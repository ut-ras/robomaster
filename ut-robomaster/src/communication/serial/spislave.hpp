...
#include "/workspaces/robomaster/ut-robomaster/taproot/modm/src/modm/platform/spi/spi_hal_2.hpp"
 ...
 */
class SpiSlave2 : public modm::SpiMaster
{
...
public:
    ...
    static void connect()
    {
        ...
        // Sck::setInput(Gpio::InputType::Floating);  // Jiyan's inspection: this is stupid.
        // Mosi::setInput(Gpio::InputType::Floating);
        // Miso::setOutput(Gpio::OutputType::PushPull);
