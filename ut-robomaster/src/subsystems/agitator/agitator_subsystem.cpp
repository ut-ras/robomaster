...
AgitatorSubsystem::AgitatorSubsystem(src::Drivers *drivers, MotorId agitatorMotorId)
    : Subsystem(drivers),
      drivers(drivers),
      agitator{drivers, M2006, agitatorMotorId, CAN_SHOOTER, false, "agitator", PID_AGITATOR}
{
}
...
AgitatorSubsystem::AgitatorSubsystem(src::Drivers *drivers, MotorId agitatorMotorId)
    : Subsystem(drivers),
      drivers(drivers),
      agitator{drivers, M3508, agitatorMotorId, CAN_SHOOTER, false, "agitator", PID_AGITATOR},
